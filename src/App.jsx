		...
		<>
			...
			>
				...
				<div ref={popUpRef} className="h-18 top-7/8 fixed w-dvw bg-babylon-blue-dark p-5 sm:left-0 sm:top-0 sm:h-dvh sm:w-auto md:left-0 md:top-0 md:h-dvh md:w-auto lg:left-0 lg:top-0 lg:h-dvh lg:w-auto">
					<div className="flex flex-row items-start md:flex-col md:items-center lg:flex-col lg:items-center">
						<button 
						...
						>
							<img
								...
								src={hoverStar ? "/src/assets/filled-star.png" : "/src/assets/star.png"}
								alt="logo"
							/>
						</button>

						<a 
							className='mt-0 ml-7 md:mt-8 md:ml-0 lg:mt-8 lg:ml-0 text-white ring-2 ring-white rounded px-4 py-2 hover:bg-white hover:text-babylon-blue-dark transition-colors'
